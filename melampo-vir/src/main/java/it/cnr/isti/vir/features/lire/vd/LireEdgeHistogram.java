...
public final class LireEdgeHistogram implements IFeature, java.io.Serializable {
	...
	public boolean equals(Object obj)	 {
		...
		LireEdgeHistogram given = (LireEdgeHistogram) obj;
	...
	public LireEdgeHistogram(ByteBuffer str) throws IOException {
	...
	public LireEdgeHistogram(DataInput str) throws IOException {
	...
	public LireEdgeHistogram(XMLStreamReader xmlr) throws XMLStreamException, MPEG7VDFormatException {
	...
	public final static double mpeg7XMDistance(LireEdgeHistogram d1, LireEdgeHistogram d2) {
...
*/
	...
	public boolean equals(IFeature givenVD) {
		...
		LireEdgeHistogram vd = (LireEdgeHistogram) givenVD;
