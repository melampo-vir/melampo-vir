...
//TODO Lo utilizza solo melampo
public class LireObjectMPG7 implements IFeaturesCollector, IHasID {
...
//	}
	...
	public LireObjectMPG7( IFeaturesCollector f) throws FeaturesCollectorException {
...
//		System.out.println(eh.toString());
	...
	public LireObjectMPG7(Integer id, IFeaturesCollector f) throws FeaturesCollectorException {
		cl = (LireColorLayout) f.getFeature(LireColorLayout.class);
		sc = (LireScalableColor) f.getFeature(LireScalableColor.class);
		eh = (LireEdgeHistogram) f.getFeature(LireEdgeHistogram.class);
		if ( cl == null ||
	...
	public LireObjectMPG7(DataInput in) throws IOException {
...
//		id = new IDString(in);
	...
	public LireObjectMPG7(ByteBuffer in) throws IOException {
		byte version = in.get();
		id = IDClasses.readData(in);
//		id = new IDString(in);
		cl = new LireColorLayout(in);
...
//	}
	...
	public int compareTo(Object that) {
		return id.compareTo(((LireObjectMPG7) that).id);
	}
	
	public boolean equals(Object obj) {
		if ( this == obj ) return true;
		LireObjectMPG7 that = (LireObjectMPG7) obj;
