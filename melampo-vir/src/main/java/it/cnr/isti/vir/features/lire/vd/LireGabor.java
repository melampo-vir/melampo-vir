...
public class LireGabor extends LireFeatures {

	private static final long serialVersionUID = 1L;

	static final byte version = 0;

	public LireGabor(ByteBuffer src) throws IOException {
		super(src, "Gabor");
	}

	public LireGabor(DataInput str) throws IOException {
		super(str, "Gabor");
	}
	...
	public LireGabor(XMLStreamReader xmlr) throws XMLStreamException,
